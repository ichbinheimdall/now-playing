...
## Customize
- Change `uid` in the image URL to your Spotify user ID.
- Adjust refresh interval in `script.js`.
...
## Credits
Powered by [spotify-github-profile](https://github.com/kittinan/spotify-github-profile) by kittinan.
